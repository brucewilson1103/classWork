...
app.get("/tables", function(req, res) {
  res.sendFile(path.join(__dirname, "./public1/tables.html"));
});

// Render reserve.html at the "/reserve" path
app.get("/reserve", function(req, res) {
  res.sendFile(path.join(__dirname, "./public1/reserve.html"));
});

// All other paths serve the home.html page
app.get("*", function(req, res) {
  res.sendFile(path.join(__dirname, "./public1/home.html"));
});
